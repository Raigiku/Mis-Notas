...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C01221();
    private final OnTouchListener mTouchListener = new C01232();
    private final View mView;

    /* renamed from: android.support.v13.view.DragStartHelper$1 */
    class C01221 implements OnLongClickListener {
        C01221() {
        }
    ...
    class C01232 implements OnTouchListener {
        C01232() {
        }

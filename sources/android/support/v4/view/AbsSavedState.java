...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C01822();
    public static final AbsSavedState EMPTY_STATE = new C03761();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C01822 implements ClassLoaderCreator<AbsSavedState> {
        C01822() {
        }
    ...
    static class C03761 extends AbsSavedState {
        C03761() {
            super();
        }
    }

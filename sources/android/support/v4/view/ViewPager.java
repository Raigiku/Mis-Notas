...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01881();
    ...
    private static final Interpolator sInterpolator = new C01892();
    ...
    private final Runnable mEndScrollRunnable = new C01903();
    ...
    static class C01881 implements Comparator<ItemInfo> {
        C01881() {
        }
    ...
    static class C01892 implements Interpolator {
    ...
    class C03774 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C01911();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01911 implements ClassLoaderCreator<SavedState> {
            C01911() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03774());
    }

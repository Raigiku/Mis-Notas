...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02042 extends Animation {
        C02042() {
        }
    ...
    class C02053 extends Animation {
        C02053() {
        }
    ...
    class C02075 implements AnimationListener {
        public void onAnimationRepeat(Animation animation) {
        }
    ...
    class C02086 extends Animation {
        C02086() {
        }
    ...
    class C02097 extends Animation {
        C02097() {
        }
    ...
    class C02108 extends Animation {
        C02108() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C02031();
        this.mAnimateToCorrectPosition = new C02086();
        this.mAnimateToStartPosition = new C02097();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C02042();
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C02053();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation c02064 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c02064.setDuration(ALPHA_ANIMATION_DURATION);
        this.mCircleView.setAnimationListener(0);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02064);
        return c02064;
    }
    ...
    private void moveSpinner(float f) {
        ...
        int i = this.mCustomSlingshotDistance > 0 ? this.mCustomSlingshotDistance : this.mUsingCustomStart ? this.mSpinnerOffsetEnd - this.mOriginalOffsetTop : this.mSpinnerOffsetEnd;
        float f2 = (float) i;
        double max2 = (double) (Math.max(0.0f, Math.min(abs, f2 * DECELERATE_INTERPOLATION_FACTOR) / f2) / 4.0f);
        double pow = Math.pow(max2, 2.0d);
        Double.isNaN(max2);
        abs = ((float) (max2 - pow)) * DECELERATE_INTERPOLATION_FACTOR;
        int i2 = this.mOriginalOffsetTop + ((int) ((f2 * min) + ((f2 * abs) * DECELERATE_INTERPOLATION_FACTOR)));
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02108();

...
public final class LinkifyCompat {
    private static final Comparator<LinkSpec> COMPARATOR = new C01811();
    private static final String[] EMPTY_STRING = new String[0];

    /* renamed from: android.support.v4.text.util.LinkifyCompat$1 */
    static class C01811 implements Comparator<LinkSpec> {
        C01811() {
        }
...
*/
        ...
        r0 = 0;
    L_0x0005:
        r1 = findAddress(r6);	 Catch:{ UnsupportedOperationException -> 0x0044 }

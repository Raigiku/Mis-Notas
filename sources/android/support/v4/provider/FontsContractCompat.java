...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C01765();
    ...
    static class C01765 implements Comparator<byte[]> {
        C01765() {
        }
...
*/
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest fontRequest, @NonNull final FontRequestCallback fontRequestCallback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C01716 implements Runnable {
                C01716() {
                }
            ...
            class C01738 implements Runnable {
                C01738() {
                }

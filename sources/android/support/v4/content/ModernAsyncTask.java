...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01541();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03692();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01541 implements ThreadFactory {
    ...
    class C03692 extends WorkerRunnable<Params, Result> {
        C03692() {
        }

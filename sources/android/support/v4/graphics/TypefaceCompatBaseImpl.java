...
class TypefaceCompatBaseImpl {
    ...
    class C03701 implements StyleExtractor<FontInfo> {
        C03701() {
        }
    ...
    class C03712 implements StyleExtractor<FontFileResourceEntry> {
        C03712() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C03701());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C03712());
    }

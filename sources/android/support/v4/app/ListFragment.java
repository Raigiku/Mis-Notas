...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01522();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01511();
    ...
    class C01522 implements OnItemClickListener {
        C01522() {
        }

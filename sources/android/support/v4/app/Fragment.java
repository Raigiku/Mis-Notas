...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C01291 implements ClassLoaderCreator<SavedState> {
            C01291() {
            }
    ...
    class C03652 extends FragmentContainer {
        C03652() {
        }
    ...
    class C03663 implements LifecycleOwner {
        C03663() {
        }
...
*/
        ...
        if (this.mFragmentManager != null) {
            if (this.mFragmentManager.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01281());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C03652(), this);
            return;
        }
    ...
    void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new C03663();

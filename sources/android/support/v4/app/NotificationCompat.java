        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            if (bitmap != null) {
                if (VERSION.SDK_INT < 27) {
                    ...
                    Double.isNaN(max);
                    return Bitmap.createScaledBitmap(bitmap, ceil, (int) Math.ceil(max * min), true);
                }
            }
            return bitmap;
        }
...
*/
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            spannableStringBuilder.append("  ").append(instance.unicodeWrap(message.getText() == null ? BuildConfig.FLAVOR : message.getText()));

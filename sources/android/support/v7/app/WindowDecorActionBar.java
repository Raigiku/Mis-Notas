...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04301();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04312();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03863();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C03863 implements ViewPropertyAnimatorUpdateListener {
        C03863() {
        }
    ...
    class C04301 extends ViewPropertyAnimatorListenerAdapter {
        C04301() {
        }
    ...
    class C04312 extends ViewPropertyAnimatorListenerAdapter {
        C04312() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0228R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0228R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0228R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0228R.id.action_bar_container);
        ...
        if (!actionBarPolicy.enableHomeButtonByDefault()) {
            if (view == null) {
                ...
                view = this.mContext.obtainStyledAttributes(null, C0228R.styleable.ActionBar, C0228R.attr.actionBarStyle, 0);
                if (view.getBoolean(C0228R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                dimensionPixelSize = view.getDimensionPixelSize(C0228R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0228R.attr.actionBarWidgetTheme, typedValue, true);

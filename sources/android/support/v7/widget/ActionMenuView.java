        ...
        while (paddingLeft < i3) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (z2) {
                    ...
                    i5 = size;
                    z = false;
                    childAt.setPadding(r0.mGeneratedItemPadding, 0, r0.mGeneratedItemPadding, 0);
                } else {
                    i5 = size;
                    i15 = i12;
                    z = false;
                ...
                size = measureChildForCells(childAt, i9, layoutParams.isOverflowButton ? 1 : i10, childMeasureSpec, paddingTop);
            ...
            while (size < i3) {
                ...
                if ((j2 & j3) != 0) {
                    ...
                    if (obj3 == null || !layoutParams3.preventEdgeOffset) {
                        ...
                        z3 = true;
                        if (i10 == 1) {
                            childAt2.setPadding(r0.mGeneratedItemPadding + i9, 0, r0.mGeneratedItemPadding, 0);
                        }
                    }
                ...
                if (obj != null) {
                    while (paddingLeft < size) {
                        ...
                        if (layoutParams4.expanded) {
                            ...
                            i3 = i7;
                            childAt3.measure(MeasureSpec.makeMeasureSpec((layoutParams4.cellsUsed * i9) + layoutParams4.extraPixels, 1073741824), i3);
                        }
                        paddingLeft++;
                        i7 = i3;
                    }

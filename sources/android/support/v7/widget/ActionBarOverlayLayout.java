...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = new int[]{C0228R.attr.actionBarSize, 16842841};
    ...
    class C02471 extends AnimatorListenerAdapter {
        C02471() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02471();
        this.mRemoveActionBarHideOffset = new C02482();
        this.mAddActionBarHideOffset = new C02493();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0228R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0228R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0228R.id.action_bar));
        }
    }

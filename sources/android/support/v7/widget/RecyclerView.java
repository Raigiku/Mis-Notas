...
import android.support.v7.recyclerview.C0232R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02743();
    ...
    static class C02743 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04101();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04112();
        private int mWidth;
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            if (i == 4096) {
                ...
                if (this.mRecyclerView.canScrollHorizontally(1) != 0) {
                    ...
                    this.mRecyclerView.smoothScrollBy(i, recycler);
                    return true;
                }
            } else if (i != 8192) {
                recycler = null;
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0232R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0232R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0232R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0232R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0232R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
            ...
            if (!viewHolder.isScrap()) {
                if (viewHolder.itemView.getParent() == null) {
                    if (viewHolder.isTmpDetached()) {
                        ...
                        Object obj = (RecyclerView.this.mAdapter != null && doesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) ? 1 : null;
                        if (obj == null) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int i5 = currX - r0.mLastFlingX;
                int i6 = currY - r0.mLastFlingY;
                ...
                if (RecyclerView.this.mAdapter != null) {
                    RecyclerView.this.scrollStep(i5, i6, RecyclerView.this.mScrollStepConsumed);
                ...
                Object obj = (i6 != 0 && RecyclerView.this.mLayout.canScrollVertically() && i2 == i6) ? 1 : null;
                Object obj2 = (i5 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i == i5) ? 1 : null;
                if (!(i5 == 0 && i6 == 0) && obj2 == null) {
                    if (obj == null) {
                        obj2 = null;
    ...
    class C04074 implements ProcessCallback {
        C04074() {
        }
    ...
    class C04085 implements Callback {
        C04085() {
        }
    ...
    class C04096 implements Callback {
        C04096() {
        }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02721();
        ...
        this.mItemAnimatorRunner = new C02732();
        this.mViewInfoProcessCallback = new C04074();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0232R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0232R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0232R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0232R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0232R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0232R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0232R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0232R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04085());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04096());
    }
    ...
    void scrollStep(int i, int i2, @Nullable int[] iArr) {
        ...
        i = i != 0 ? this.mLayout.scrollHorizontallyBy(i, this.mRecycler, this.mState) : 0;
        i2 = i2 != 0 ? this.mLayout.scrollVerticallyBy(i2, this.mRecycler, this.mState) : 0;
        TraceCompat.endSection();
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            scrollStep(i7, i8, r7.mScrollStepConsumed);
            int i9 = r7.mScrollStepConsumed[0];
            int i10 = r7.mScrollStepConsumed[1];
            i3 = i9;
            i4 = i10;
            i5 = i7 - i9;
            i6 = i8 - i10;
        ...
        int i11 = i6;
        if (dispatchNestedScroll(i3, i4, i5, i6, r7.mScrollOffset, 0)) {
            r7.mLastTouchX -= r7.mScrollOffset[0];
            r7.mLastTouchY -= r7.mScrollOffset[1];
            if (motionEvent2 != null) {
                motionEvent2.offsetLocation((float) r7.mScrollOffset[0], (float) r7.mScrollOffset[1]);
            }
            ...
            if (!(motionEvent2 == null || MotionEventCompat.isFromSource(motionEvent2, 8194))) {
                pullGlows(motionEvent.getX(), (float) i5, motionEvent.getY(), (float) i11);
            }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0232R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0232R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0232R.dimen.fastscroll_margin));
    }

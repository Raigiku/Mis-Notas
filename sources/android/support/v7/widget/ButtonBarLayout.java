...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0228R.styleable.ButtonBarLayout);
        this.mAllowStacking = context.getBoolean(C0228R.styleable.ButtonBarLayout_allowStacking, true);
        context.recycle();
    }
    ...
    private void setStacked(boolean z) {
        setOrientation(z);
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0228R.id.spacer);

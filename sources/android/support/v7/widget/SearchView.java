...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02793 implements OnFocusChangeListener {
        C02793() {
        }
    ...
    class C02804 implements OnLayoutChangeListener {
        C02804() {
        }
    ...
    class C02815 implements OnClickListener {
        C02815() {
        }
    ...
    class C02826 implements OnKeyListener {
        C02826() {
        }
    ...
    class C02837 implements OnEditorActionListener {
        C02837() {
        }
    ...
    class C02848 implements OnItemClickListener {
        C02848() {
        }
    ...
    class C02859 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02861 implements ClassLoaderCreator<SavedState> {
            C02861() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0228R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C02871();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0228R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02771();
        this.mReleaseCursorRunnable = new C02782();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02815();
        this.mTextKeyListener = new C02826();
        this.mOnEditorActionListener = new C02837();
        this.mOnItemClickListener = new C02848();
        this.mOnItemSelectedListener = new C02859();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0228R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0228R.styleable.SearchView_layout, C0228R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0228R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0228R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0228R.id.search_plate);
        this.mSubmitArea = findViewById(C0228R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0228R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0228R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0228R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0228R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0228R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0228R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0228R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0228R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0228R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0228R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0228R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0228R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0228R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0228R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0228R.styleable.SearchView_suggestionRowLayout, C0228R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0228R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02793());
        setIconifiedByDefault(attributeSet.getBoolean(C0228R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0228R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0228R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0228R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0228R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0228R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0228R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02804());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0228R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0228R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0228R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0228R.dimen.abc_dropdownitem_text_padding_left) : 0;

...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    private static final int ITEM_LAYOUT = C0228R.layout.abc_popup_menu_item_layout;
    private final MenuAdapter mAdapter;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02432();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C02421();
    ...
    class C02421 implements OnGlobalLayoutListener {
        C02421() {
        }
    ...
    class C02432 implements OnAttachStateChangeListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(i.getDisplayMetrics().widthPixels / 2, i.getDimensionPixelSize(C0228R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            if (this.mAnchorView != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0228R.layout.abc_popup_menu_header_item_layout, listView, false);

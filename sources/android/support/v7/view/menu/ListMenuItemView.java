...
public class ListMenuItemView extends LinearLayout implements ItemView, SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0228R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet);
        attributeSet = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0228R.styleable.MenuView, i, 0);
        this.mBackground = attributeSet.getDrawable(C0228R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = attributeSet.getResourceId(C0228R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = attributeSet.getBoolean(C0228R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = attributeSet.getDrawable(C0228R.styleable.MenuView_subMenuArrow);
        context = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0228R.attr.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0228R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0228R.id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0228R.id.submenuarrow);
        if (this.mSubMenuArrowView != null) {
            this.mSubMenuArrowView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0228R.id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0228R.id.content);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0228R.layout.abc_list_menu_item_icon, this, false);
        addContentView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0228R.layout.abc_list_menu_item_radio, this, false);
        addContentView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0228R.layout.abc_list_menu_item_checkbox, this, false);

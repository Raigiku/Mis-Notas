...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C02351();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C02351 implements Comparator<Snake> {
        C02351() {
        }
                    ...
                    for (i7 = i16; i7 <= i12; i7 += 2) {
                        ...
                        if (i8 != i12 + i9) {
                            ...
                            if (obj == null || i8 < i16 || i8 > i12 || iArr3[i19] < iArr4[i19]) {
                                ...
                                snake = new Snake();
                                snake.f11x = iArr4[i19];
                                snake.f12y = snake.f11x - i8;

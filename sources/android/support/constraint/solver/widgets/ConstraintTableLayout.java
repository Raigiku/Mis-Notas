...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    private void setChildrenConnections() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            HorizontalSlice horizontalSlice = (HorizontalSlice) this.mHorizontalSlices.get(i / this.mNumCols);
            VerticalSlice verticalSlice = (VerticalSlice) this.mVerticalSlices.get(i % this.mNumCols);

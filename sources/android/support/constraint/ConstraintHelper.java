...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            attributeSet = getContext().obtainStyledAttributes(attributeSet, C0016R.styleable.ConstraintLayout_Layout);
            int indexCount = attributeSet.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = attributeSet.getIndex(i);
                if (index == C0016R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
...
*/
    ...
    L_0x0008:
        ...
        r0 = 0;
        r1 = 0;
        r2 = android.support.constraint.C0016R.id.class;	 Catch:{ Exception -> 0x0019 }

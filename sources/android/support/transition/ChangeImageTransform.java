...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C01061();
    ...
    static class C01061 implements TypeEvaluator<Matrix> {
...
*/
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C01083.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:

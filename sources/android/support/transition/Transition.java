...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C03631();
    ...
    class C01173 extends AnimatorListenerAdapter {
        C01173() {
        }
    ...
    static class C03631 extends PathMotion {
        C03631() {
        }
                            ...
                            if (createAnimator != null) {
                                ...
                                if (obj2 == null) {
                                    if (transition.mPropagation != null) {
                                        startDelay = transition.mPropagation.getStartDelay(viewGroup2, transition, transitionValues, transitionValues2);
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C01173());
        animator.start();
    }

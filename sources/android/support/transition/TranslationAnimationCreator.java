...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        private int[] mTransitionPosition = ((int[]) this.mViewInHierarchy.getTag(C0115R.id.transition_position));
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0115R.id.transition_position, 0);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0115R.id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0115R.id.transition_position);
        if (iArr != null) {
        ...
        transitionValues = new TransitionPositionListener(view, transitionValues2.view, round, round2, translationX, translationY);
        ofPropertyValuesHolder.addListener(transitionValues);
        AnimatorUtils.addPauseListener(ofPropertyValuesHolder, transitionValues);

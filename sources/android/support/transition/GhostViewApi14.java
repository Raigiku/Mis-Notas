...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C01121();
    int mReferences;
    ...
    class C01121 implements OnPreDrawListener {
        C01121() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostViewApi14) {
        view.setTag(C0115R.id.ghost_view, ghostViewApi14);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0115R.id.ghost_view);
    }
}

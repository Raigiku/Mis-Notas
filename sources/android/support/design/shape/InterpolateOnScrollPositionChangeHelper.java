...
public class InterpolateOnScrollPositionChangeHelper {
    ...
    private final OnScrollChangedListener scrollChangedListener = new C00451();
    private final int[] scrollLocation = new int[2];
    private View shapedView;

    /* renamed from: android.support.design.shape.InterpolateOnScrollPositionChangeHelper$1 */
    class C00451 implements OnScrollChangedListener {
        C00451() {
        }

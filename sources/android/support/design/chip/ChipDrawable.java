...
public class ChipDrawable extends Drawable implements TintAwareDrawable, Callback {
    ...
    private final FontCallback fontCallback = new C03371();
    ...
    class C03371 extends FontCallback {
    ...
    public static ChipDrawable createFromResource(Context context, @XmlRes int i) {
        try {
            ...
            if (next != 2) {
                ...
                if (next == 0) {
                    next = C0026R.style.Widget_MaterialComponents_Chip_Entry;
                }
                return createFromAttributes(context, asAttributeSet, C0026R.attr.chipStandaloneStyle, next);
            } else {
    ...
    private void drawText(@NonNull Canvas canvas, Rect rect) {
        if (this.unicodeWrappedText != null) {
            ...
            if (!(rect == null || this.truncateAt == null)) {
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        colorForState = this.chipStrokeColor != null ? this.chipStrokeColor.getColorForState(iArr, this.currentChipStrokeColor) : 0;
        if (this.currentChipStrokeColor != colorForState) {
            this.currentChipStrokeColor = colorForState;
            onStateChange = true;
        }
        colorForState = this.compatRippleColor != null ? this.compatRippleColor.getColorForState(iArr, this.currentCompatRippleColor) : 0;
        ...
        colorForState = (this.textAppearance == null || this.textAppearance.textColor == null) ? 0 : this.textAppearance.textColor.getColorForState(iArr, this.currentTextColor);

...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C03541 implements OnApplyWindowInsetsListener {
        C03541() {
        }
    ...
    private class OffsetUpdateListener implements OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            appBarLayout = CollapsingToolbarLayout.this.lastInsets != null ? CollapsingToolbarLayout.this.lastInsets.getSystemWindowInsetTop() : null;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.collapsingTextHelper.setCollapsedTextAppearance(C0228R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03541());
    }
    ...
    private boolean isToolbarChild(View view) {
        if (this.toolbarDirectChild != null) {
            if (this.toolbarDirectChild != this) {
                return view == this.toolbarDirectChild;
            }
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.lastInsets) {
            z = this.lastInsets.getSystemWindowInsetTop();
            int childCount = getChildCount();
        ...
        if (this.collapsingTitleEnabled && this.dummyView) {
            Object obj = 1;
            z = ViewCompat.isAttachedToWindow(this.dummyView) && !this.dummyView.getVisibility();
            this.drawCollapsingTitle = z;
            if (this.drawCollapsingTitle) {
                if (!ViewCompat.getLayoutDirection(this)) {
                    obj = null;
                }
                z = getMaxOffsetForPinChild(this.toolbarDirectChild ? this.toolbarDirectChild : this.toolbar);
    ...
    public void setStatusBarScrim(@Nullable Drawable drawable) {
        if (this.statusBarScrim != drawable) {
            ...
            if (this.statusBarScrim != null) {
                if (this.statusBarScrim.isStateful() != null) {
    ...
    protected void drawableStateChanged() {
        ...
        if (this.collapsingTextHelper != null) {
            i |= this.collapsingTextHelper.setState(drawableState);
        }
        if (i != 0) {
            invalidate();
        }

...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.view.getContext(), i, C0228R.styleable.TextAppearance);
        if (obtainStyledAttributes.hasValue(C0228R.styleable.TextAppearance_android_textColor)) {
            this.collapsedTextColor = obtainStyledAttributes.getColorStateList(C0228R.styleable.TextAppearance_android_textColor);
        }
        if (obtainStyledAttributes.hasValue(C0228R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = (float) obtainStyledAttributes.getDimensionPixelSize(C0228R.styleable.TextAppearance_android_textSize, (int) this.collapsedTextSize);
        }
        this.collapsedShadowColor = obtainStyledAttributes.getInt(C0228R.styleable.TextAppearance_android_shadowColor, 0);
        this.collapsedShadowDx = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.collapsedShadowDy = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.collapsedShadowRadius = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowRadius, 0.0f);
    ...
    public void setExpandedTextAppearance(int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.view.getContext(), i, C0228R.styleable.TextAppearance);
        if (obtainStyledAttributes.hasValue(C0228R.styleable.TextAppearance_android_textColor)) {
            this.expandedTextColor = obtainStyledAttributes.getColorStateList(C0228R.styleable.TextAppearance_android_textColor);
        }
        if (obtainStyledAttributes.hasValue(C0228R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = (float) obtainStyledAttributes.getDimensionPixelSize(C0228R.styleable.TextAppearance_android_textSize, (int) this.expandedTextSize);
        }
        this.expandedShadowColor = obtainStyledAttributes.getInt(C0228R.styleable.TextAppearance_android_shadowColor, 0);
        this.expandedShadowDx = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.expandedShadowDy = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.expandedShadowRadius = obtainStyledAttributes.getFloat(C0228R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        obtainStyledAttributes.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    private Typeface readFontFamilyTypeface(int i) {
        i = this.view.getContext().obtainStyledAttributes(i, new int[]{16843692});
        try {
    ...
    private void setInterpolatedTextSize(float f) {
        ...
        f = (USE_SCALING_TEXTURE == null || this.scale == 1.0f) ? 0.0f : Float.MIN_VALUE;
        this.useTexture = f;
    ...
    private void calculateUsingTextSize(float f) {
        if (this.text != null) {
            ...
            if (width > 0.0f) {
                if (this.currentTextSize == f2 && this.boundsChanged == null) {
                    if (obj == null) {
                        obj = null;
            ...
            if (this.textToDraw == null || r6 != null) {
                ...
                f.setLinearText(z);
                f = TextUtils.ellipsize(this.text, this.textPaint, width, TruncateAt.END);
                if (!TextUtils.equals(f, this.textToDraw)) {
                    this.textToDraw = f;

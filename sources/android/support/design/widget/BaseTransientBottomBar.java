...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback managerCallback = new C03444();
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        class C03481 implements TouchExplorationStateChangeListener {
            C03481() {
            }
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            this.touchExplorationStateChangeListener = new C03481();
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (this.onLayoutChangeListener) {
    ...
    class C03422 implements OnApplyWindowInsetsListener {
        C03422() {
        }
    ...
    class C03433 extends AccessibilityDelegateCompat {
        C03433() {
        }
    ...
    class C03444 implements Callback {
        C03444() {
        }
    ...
    class C03455 implements OnDismissListener {
        C03455() {
        }
    ...
    class C03466 implements OnAttachStateChangeListener {
    ...
    class C03477 implements OnLayoutChangeListener {
        C03477() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull android.support.design.snackbar.ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.view, new C03422());
            ViewCompat.setAccessibilityDelegate(this.view, new C03433());
    ...
    final void showView() {
        if (this.view.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                android.support.design.widget.CoordinatorLayout.Behavior newBehavior = this.behavior == null ? getNewBehavior() : this.behavior;
                if (newBehavior instanceof Behavior) {
                    ((Behavior) newBehavior).setBaseTransientBottomBar(this);
                }
                newBehavior.setListener(new C03455());
                layoutParams2.setBehavior(newBehavior);
                layoutParams2.insetEdge = 80;
            }
            this.targetParent.addView(this.view);
        }
        this.view.setOnAttachStateChangeListener(new C03466());
        if (!ViewCompat.isLaidOut(this.view)) {
            this.view.setOnLayoutChangeListener(new C03477());

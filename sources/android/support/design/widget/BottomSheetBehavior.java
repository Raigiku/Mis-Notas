...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    int collapsedOffset;
    private final Callback dragCallback = new C03502();
    ...
    class C03502 extends Callback {
        ...
        public void onViewReleased(@NonNull View view, float f, float f2) {
            ...
            if (f2 < 0.0f) {
                ...
                f = view.getTop();
                if (BottomSheetBehavior.this.fitToContents == null) {
                    if (f < BottomSheetBehavior.this.halfExpandedOffset) {
                    ...
                    BottomSheetBehavior.this.setStateInternal(i);
                    return;
                } else if (Math.abs(f - BottomSheetBehavior.this.fitToContentsOffset) < Math.abs(f - BottomSheetBehavior.this.collapsedOffset)) {
                    int i3 = BottomSheetBehavior.this.fitToContentsOffset;
                } else {
                    i2 = BottomSheetBehavior.this.collapsedOffset;
                }
                f = i2;
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        } else if (this.hideable != 0 && this.state == 5) {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (v.isShown()) {
            ...
            if (this.ignoreEvents == null && this.viewDragHelper != null && this.viewDragHelper.shouldInterceptTouchEvent(motionEvent) != null) {
                return true;
            }
    ...
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull View view, int i, int i2, @NonNull int[] iArr, int i3) {
        if (i3 != 1 && view == ((View) this.nestedScrollingChildRef.get())) {
            ...
            if (i2 > 0) {
                ...
                if (i3 > this.collapsedOffset) {
                    if (this.hideable == null) {
                        iArr[1] = i - this.collapsedOffset;
                        ViewCompat.offsetTopAndBottom(v, -iArr[1]);
                        setStateInternal(4);
                    }
                }
                ...
                if (this.lastNestedScrollDy > null) {
                    ...
                    if (this.lastNestedScrollDy == null) {
                        ...
                        if (!this.fitToContents) {
                            if (coordinatorLayout < this.halfExpandedOffset) {
                                if (coordinatorLayout < Math.abs(coordinatorLayout - this.collapsedOffset)) {
                                    coordinatorLayout = null;
                                } else {
                                    coordinatorLayout = this.halfExpandedOffset;
                                }
                            } else if (Math.abs(coordinatorLayout - this.halfExpandedOffset) < Math.abs(coordinatorLayout - this.collapsedOffset)) {
                                coordinatorLayout = this.halfExpandedOffset;
                            } else {
    ...
    public final void setPeekHeight(int i) {
        ...
        if (i != -1) {
            ...
            if (!z && this.state == 4 && this.viewRef != 0) {

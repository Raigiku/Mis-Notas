...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (this.indicatorAnimator && this.indicatorAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
    ...
    class TabView extends LinearLayout {
        ...
        private void updateBackgroundDrawable(Context context) {
            if (TabLayout.this.tabBackgroundResId != 0) {
                ...
                if (!(this.baseBackgroundDrawable == null || this.baseBackgroundDrawable.isStateful() == null)) {
        ...
        final void update() {
            ...
            if (this.customView == null) {
                if (this.iconView == null) {
                    ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0026R.layout.design_layout_tab_icon, this, false);
                    addView(imageView, 0);
                ...
                if (this.textView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0026R.layout.design_layout_tab_text, this, false);
                    addView(textView);
        ...
        private void updateTextAndIcon(@Nullable TextView textView, @Nullable ImageView imageView) {
            ...
            textView = this.tab != null ? this.tab.contentDesc : null;
            if (isEmpty != 0) {
                textView = null;
            }
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        i = context.obtainStyledAttributes(this.tabTextAppearance, C0228R.styleable.TextAppearance);
        try {
            this.tabTextSize = (float) i.getDimensionPixelSize(C0228R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, i, C0228R.styleable.TextAppearance_android_textColor);

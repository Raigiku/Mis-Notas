...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            attributeSet = context.obtainStyledAttributes(attributeSet, C0026R.styleable.AppBarLayout_Layout);
            this.scrollFlags = attributeSet.getInt(C0026R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (attributeSet.hasValue(C0026R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = AnimationUtils.loadInterpolator(context, attributeSet.getResourceId(C0026R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        protected static class SavedState extends AbsSavedState {
            public static final Creator<SavedState> CREATOR = new C00551();
            boolean firstVisibleChildAtMinimumHeight;
            int firstVisibleChildIndex;
            float firstVisibleChildPercentageShown;

            /* renamed from: android.support.design.widget.AppBarLayout$BaseBehavior$SavedState$1 */
            static class C00551 implements ClassLoaderCreator<SavedState> {
                C00551() {
                }
        ...
        public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, T t, View view, View view2, int i, int i2) {
            coordinatorLayout = ((i & 2) == null || (t.isLiftOnScroll() == null && canScrollChildren(coordinatorLayout, t, view) == null)) ? null : true;
            if (!(coordinatorLayout == null || this.offsetAnimator == null)) {
        ...
        private boolean canScrollChildren(CoordinatorLayout coordinatorLayout, T t, View view) {
            return (!t.hasScrollableChildren() || coordinatorLayout.getHeight() - view.getHeight() > t.getHeight()) ? null : true;
        }
        ...
        public void onNestedScroll(CoordinatorLayout coordinatorLayout, T t, View view, int i, int i2, int i3, int i4, int i5) {
            ...
            if (t.isLiftOnScroll() != null) {
                t.setLiftedState(view.getScrollY() > null ? true : null);
            }
        }
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, T t, int i, float f) {
            ...
            f = Math.abs(f);
            if (f > 0.0f) {
                f = Math.round((((float) abs) / f) * 1000.0f) * 3;
            } else {
                f = (int) (((((float) abs) / ((float) t.getHeight())) + 1.0f) * 150.0f);
            }
            animateOffsetWithDuration(coordinatorLayout, t, i, f);
        }
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
            if (getTopBottomOffsetForScrollingSibling() == i) {
                if (!(this.offsetAnimator == null || this.offsetAnimator.isRunning() == null)) {
                    this.offsetAnimator.cancel();
                }
                return;
            }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            i = super.onLayoutChild(coordinatorLayout, t, i);
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 == 0 || topBottomOffsetForScrollingSibling < i2 || topBottomOffsetForScrollingSibling > i3) {
                ...
                if (topBottomOffsetForScrollingSibling != clamp) {
                    i = t.hasChildWithInterpolator() != 0 ? interpolateOffset(t, clamp) : clamp;
                    i2 = setTopAndBottomOffset(i);
                    i4 = topBottomOffsetForScrollingSibling - clamp;
                    this.offsetDelta = clamp - i;
                    if (i2 == 0 && t.hasChildWithInterpolator() != 0) {
            ...
            while (i3 < childCount) {
                ...
                if (abs < childAt.getTop() || abs > childAt.getBottom()) {
                    ...
                    if (scrollInterpolator != null) {
                        ...
                        if (i2 > 0) {
                            t = (float) i2;
                            return Integer.signum(i) * (childAt.getTop() + Math.round(t * scrollInterpolator.getInterpolation(((float) (abs - childAt.getTop())) / t)));
                        }
                    }
                    return i;
                }
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            coordinatorLayout = coordinatorLayout.getDependents(t);
            t = coordinatorLayout.size();
            boolean z = false;
            for (T t2 = null; t2 < t; t2++) {
                android.support.design.widget.CoordinatorLayout.Behavior behavior = ((android.support.design.widget.CoordinatorLayout.LayoutParams) ((View) coordinatorLayout.get(t2)).getLayoutParams()).getBehavior();
                if (behavior instanceof ScrollingViewBehavior) {
                    if (((ScrollingViewBehavior) behavior).getOverlayTop() != null) {
                        z = true;
                    }
                    return z;
                }
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            coordinatorLayout = super.onSaveInstanceState(coordinatorLayout, t);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            context = context.obtainStyledAttributes(attributeSet, C0026R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(context.getDimensionPixelSize(C0026R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            context.recycle();
        }
        ...
        private static int getAppBarLayoutOffset(AppBarLayout appBarLayout) {
            ...
            return appBarLayout instanceof BaseBehavior ? ((BaseBehavior) appBarLayout).getTopBottomOffsetForScrollingSibling() : null;
        }
        ...
        private void updateLiftedStateIfNeeded(View view, View view2) {
            if (view2 instanceof AppBarLayout) {
                ...
                if (appBarLayout.isLiftOnScroll()) {
                    appBarLayout.setLiftedState(view.getScrollY() > null ? true : null);
                }
            }
        }
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0026R.style.Widget_Design_AppBarLayout);
        }
        context = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0026R.styleable.AppBarLayout, 0, C0026R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, context.getDrawable(C0026R.styleable.AppBarLayout_android_background));
        if (context.hasValue(C0026R.styleable.AppBarLayout_expanded) != null) {
            setExpanded(context.getBoolean(C0026R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && context.hasValue(C0026R.styleable.AppBarLayout_elevation) != null) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) context.getDimensionPixelSize(C0026R.styleable.AppBarLayout_elevation, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (context.hasValue(C0026R.styleable.AppBarLayout_android_keyboardNavigationCluster) != null) {
                setKeyboardNavigationCluster(context.getBoolean(C0026R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (context.hasValue(C0026R.styleable.AppBarLayout_android_touchscreenBlocksFocus) != null) {
                setTouchscreenBlocksFocus(context.getBoolean(C0026R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = context.getBoolean(C0026R.styleable.AppBarLayout_liftOnScroll, false);
        context.recycle();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        i = getChildCount();
        for (i2 = 0; i2 < i; i2++) {
            if (((LayoutParams) getChildAt(i2).getLayoutParams()).getScrollInterpolator() != 0) {
                this.haveChildWithInterpolator = true;
                break;
            }
        }
        if (this.liftableOverride == 0) {
            if (!(this.liftOnScroll == 0 && hasCollapsibleChild() == 0)) {
                z = true;
            }
            setLiftableState(z);
        }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0026R.attr.state_liftable : -C0026R.attr.state_liftable;
        int i2 = (this.liftable && this.lifted) ? C0026R.attr.state_lifted : -C0026R.attr.state_lifted;
        iArr[1] = i2;
        iArr[2] = this.liftable ? C0026R.attr.state_collapsible : -C0026R.attr.state_collapsible;
        i2 = (this.liftable && this.lifted) ? C0026R.attr.state_collapsed : -C0026R.attr.state_collapsed;
        iArr[3] = i2;
